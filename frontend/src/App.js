...
return (
    ...
    <TravelAgencyGuardedRoute exact path='/travelAgency/deletetrip'    component={DeleteTrip}  deleteTrip={deleteTrip} tripOperator={this.state.name} trips={this.state.dashboardTrips} auth={this.state.adminAuthenticated ||  this.state.travelAgencyAuthenticated}  />
    <TravelAgencyGuardedRoute exact path='/travelAgency/updatetrip'    component={UpdateTripPage}  updateTrip={updateTrip} tripOperator={this.state.name} trips={this.state.dashboardTrips} auth={this.state.adminAuthenticated ||  this.state.travelAgencyAuthenticated}  />
